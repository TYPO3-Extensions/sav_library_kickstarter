...
t3lib_extMgm::addPItoST43($_EXTKEY, 'Classes/class.tx_{sav:function(name:"removeUnderscore", arguments:"{extension.general.1.extensionKey}")}_pi1.php', '_pi1', 'list_type', 1);
</sav:function>
?>
