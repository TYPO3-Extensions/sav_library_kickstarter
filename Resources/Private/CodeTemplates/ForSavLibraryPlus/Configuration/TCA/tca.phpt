...
$TCA['{model}'] = array (
    ...
    <f:if condition="{newTable.add_access}">
		...
		'{field.fieldname}' => array (
			...
			'config' => array (
				<sav:indent count="4"><sav:render partial="../CodeTemplates/ForSavLibraryPlus/Partials/TCA/{field.type}.phpt" arguments="{field:field,model:model,extensionKey:extension.general.1.extensionKey}" /></sav:indent>
			)
		),
		</sav:removeIfContainsDoNotCreate>
		</f:for>
