...
'foreign_table_where' => '{whereClause}{sav:buildOrderByClauseForRelationTable(arguments:extension,tableName:field.conf_custom_table_name)}',
</f:then>
<f:else>
'foreign_table' => '{field.conf_rel_table}',
'foreign_table_where' => '{whereClause}{sav:buildOrderByClauseForRelationTable(arguments:extension,tableName:field.conf_rel_table)}',
</f:else>
</f:if>
'size' => 1,
'minitems' => 0,
