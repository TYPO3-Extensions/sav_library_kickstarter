<?php
namespace SAV\SavLibraryKickstarter\Core\Parser;
/*                                                                        *
...
//			$node = $this->objectManager->get('TYPO3\\CMS\\Fluid\\Core\\Parser\\SyntaxTree\\ObjectAccessorNode', $objectAccessorString);
			$node = $this->objectManager->get('SAV\\SavLibraryKickstarter\\Core\\Parser\\SyntaxTree\\ObjectAccessorNode', $objectAccessorString);
...
//					$arrayToBuild[$arrayKey] = $this->objectManager->get('TYPO3\\CMS\\Fluid\\Core\\Parser\\SyntaxTree\\ObjectAccessorNode', $singleMatch['VariableIdentifier']);
					$arrayToBuild[$arrayKey] = $this->objectManager->get('SAV\\SavLibraryKickstarter\\Core\\Parser\\SyntaxTree\\ObjectAccessorNode', $singleMatch['VariableIdentifier']);
