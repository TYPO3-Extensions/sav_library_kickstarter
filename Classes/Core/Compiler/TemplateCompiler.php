<?php
namespace SAV\SavLibraryKickstarter\Core\Compiler;
/*                                                                        *
...
//			'execution' => sprintf('Tx_Fluid_Core_Parser_SyntaxTree_ObjectAccessorNode::getPropertyPath($renderingContext->getTemplateVariableContainer(), \'%s\', $renderingContext)', $node->getObjectPath())
			'execution' => sprintf('SAV\\SavLibraryKickstarter\\Core\\Parser\\SyntaxTree\\ObjectAccessorNode::getPropertyPath($renderingContext->getTemplateVariableContainer(), \'%s\', $renderingContext)', $node->getObjectPath())
		);
	}
