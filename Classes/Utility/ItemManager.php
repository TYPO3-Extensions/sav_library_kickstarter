...
class Tx_SavLibraryKickstarter_Utility_ItemManager extends ArrayObject {
  ...
  public function getItems() {
	 ...
	 * Deletes an item.
	 *
	 * @param mixed $itemKey The key of the item to delete
   * return none
	 */
   ...
   * return Tx_SavLibraryKickstarter_Utility_ItemManager
	 ...
	 * Replaces an item.
	 *
	 * @param mixed $itemValues The item values to replace
   * return none
	 */
  ...
  public function reIndexKeys() {
	 ...
	 *
	 * @param string $functionName The function to apply
	 * @param ArrayObject $item The item or sub-item.
	 * return none
	 */
