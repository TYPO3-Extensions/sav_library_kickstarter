 ...
 * @scope prototype
 */
require_once(t3lib_extMgm::extPath('sav_library_kickstarter') . 'Classes/ViewHelpers/FlashHtmlMessagesViewHelper.php');

class Tx_SavLibraryKickstarter_ViewHelpers_FlashHtmlMessagesViewHelper extends \SAV\SavLibraryKickstarter\ViewHelpers\FlashHtmlMessagesViewHelper {
}
?>
